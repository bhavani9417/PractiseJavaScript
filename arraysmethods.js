//1. map: map method calls the fun one time for each ele in the array
let numbers = [1,2,3];
...
//3. reduce:calls the callback fun for all the ele in an array. the return value of the callback funis the accumalated result
